...
- **Fleet commander > individual contributor** — The multiplier comes from delegation with trust, not typing faster. Orchestrating parallel agents beats sequential hand-coding. But delegation requires trustworthy feedback loops — you can only command a fleet with reliable constraints. ([[developer-to-fleet-commander]], [[10x-is-the-new-floor]], [[worktree-pipeline]])
